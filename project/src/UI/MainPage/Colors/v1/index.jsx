            ...
            <div className="mt-16 pointer-events-none relative flex ">
              <div className=" flex min-w-full shrink-0 items-center justify-around gap-8 ">
                ...
                <img
                  ...
                  src="https://zovrus.ru/files/_cache/product/chr-1885.resize1200x1200w.jpg"
                  alt="цвет кухни"
                />

                <img
                  className="aspect-square max-w-[clamp(22rem,28vmin,22rem)] rounded-md object-cover shadow-2xl shadow-[#5a5a74] "
                  src="https://zovrus.ru/files/_cache/product/dsc07509.resize800x800w.jpg"
                  alt="цвет кухни"
                />

                <img
                  className="aspect-square max-w-[clamp(22rem,28vmin,22rem)] rounded-md object-cover shadow-2xl shadow-gray-800"
                  src="https://zovrus.ru/files/_cache/product/dsc08647.resize1200x1200w.jpg"
                  alt="цвет кухни"
                />
              </div>
            </div>
