        ...
        <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-2xl lg:pt-8">
          ...
          <div className="mt-8 sm:mt-12 lg:mt-16">
            <a href="#" className="inline-flex space-x-6">
              <span className="rounded-full bg-indigo-500/10 px-3 py-1 text-xs sm:text-sm font-semibold leading-6 text-indigo-400 ring-1 ring-inset ring-indigo-500/20">
                Мебель для жизни
              </span>
              ...
              <button
                ...
                className="inline-flex items-center space-x-2 text-xs md:text-sm font-medium leading-6 text-gray-300"
              >
          ...
          <button
            ...
            className=" inline-flex items-center py-4 px-10 font-medium text-center text-gray-800 rounded-lg bg-gray-50 hover:bg-gray-100 focus:ring-4 "
          >
