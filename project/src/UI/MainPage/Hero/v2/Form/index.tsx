...
export default () => {
  ...
  return (
    <div className="relative isolate p-4 mt-2">
        ...
        <div className="mt-2 flex flex-col gap-16 sm:gap-y-20 lg:flex-row">
          <form onSubmit={handleSendFormCalculation} className="lg:flex-auto">
            <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
              ...
              <div>
                <label
                  ...
                  className="block text-sm font-semibold leading-6 text-gray-900"
                >
                  Телефон <sup className="text-red-700 w-4 h-4">&#x2736;</sup>
                </label>
                <div className="mt-2.5">
                  <input
            ...
            <div className="mt-10">
              <button
                type="submit"
                className="block w-full rounded-md  px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 animate-background-shine items-center justify-center  border border-red-800 bg-[linear-gradient(110deg,#b91c1c,45%,#dc2626,55%,#b91c1c)] bg-[length:200%_100%]  transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50"
              >
                Узнать цену
              </button>
            </div>
            <p className="mt-4 text-sm leading-6 text-gray-500">
              ...
              <Link href="/police" className="font-semibold text-gray-900">
