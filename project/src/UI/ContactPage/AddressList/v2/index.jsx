    ...
    <div className="flex flex-col gap-8 lg:items-center lg:gap-16 lg:flex-row">
      <div className="lg:max-w-xl xl:shrink-0">
        <div>
          ...
          <p className="mt-5 text-base font-normal text-gray-500 dark:text-gray-400 md:max-w-3xl sm:text-xl">Телефон: 8 (915) 400-00-20
</p>
        </div>
      ...
      <div id="default-carousel" className="relative w-full" data-carousel="slide">
        <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
                <img src="https://zovrus.ru/files/_cache/salon/chr-5021.resize1000x1000.jpg?958f4e8d32d39d338cc431051b3b44e2" className="absolute rounded-lg block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt=""/>
        </div>
